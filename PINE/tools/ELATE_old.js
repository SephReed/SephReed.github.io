...
ELATE.noCopy.fromBuilder = ["constructor", "super", "__elate__", "extend", "isAbstract", "canEvolve", "evolve"];
...
ELATE.interface = function(evolveMe, interfaceName) {
	var interface = ELATE.get(interfaceName);

	if(interface == undefined)
		return console.error("can not find interface ", interfaceName);
