function run10() {
	...
	//SUCCESS
	// var encrypted = CT.CBC_Encrypt("0123456789ABCDEF!@#$%^&*QGMLWYFU", AES_Encrypt, key);
	// console.log(encrypted)

	// var decrypted = CT.CBC_Decrypt(encrypted, AES_Decrypt, key);
	// console.log(decrypted);

	var decryptMe = encryptedFile.replace(' ', '');
	decryptMe = CT.hexToString(CT.base64ToHex(decryptMe));

	var result = CT.CBC_Decrypt(decryptMe, AES_Decrypt, key);
	console.log(result);
...
var encryptedFile = "CRIwqt4+szDbqkNY+I0qbNXPg1XLaCM5etQ5Bt9DRFV/xIN2k8Go7jtArLIy "
